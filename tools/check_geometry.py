...
for vx in (-32, -16, 16, 32):
    FURNITURE.append((vx, 38.2, 4, 3, "vending"))
...
POINTS = {
    ...
    "waypoint": [(-48, -42), (0, -42), (48, -42),
                 ...
                 (-75, 0), (75, -6), (0, -60)],
    "npc_spawn": [(90, 0), (-75, 0), (0, 42), (30, -60)],
    "sweep_route": [(-48, -42), (48, -42), (-48, 42), (48, 42)],
    "nickel": [(-30, -42), (30, 42), (48, 0), (-48, 20)],
    "item": [(-22, -60), (18, 60), (-75, -16), (66, -16)],
